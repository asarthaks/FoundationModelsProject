...
class Attention(nn.Module):
    def __init__(
        ...
        ## Can't understand this part, need to use chatgpt
        if window_size:
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # this is used to get the embeddings of a patch using a conv2d operator
        ...
        # they are not using this in the code as of now, so not looking into it, but i think this basically introduces rel pos MHA
    ...
    def forward_features(self, x, is_train=True, return_cls=False):
        x = self.patch_embed(x)
        batch_size, seq_len, _ = x.size()
